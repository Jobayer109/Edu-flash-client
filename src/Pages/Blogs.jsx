...
const Blogs = () => {
  return (
    <div className="max-w-xl p-8 mx-auto dark:bg-gray-800 dark:text-gray-100 h-screen">
            ...
            <div className="flex items-center justify-between space-x-4 dark:text-gray-400">
              ...
              >
                <span
                  ...
                  className="h-1.5 w-1.5 rounded-full dark:bg-violet-400"
                ></span>
                <span className="group-hover:underline dark:text-gray-100">Bugfix</span>
              </a>
              <span className="text-xs whitespace-nowrap">2 weeks ago</span>
            </div>
            <div className="space-y-2">
              <p>
                Scelerisque amet elit non sit ut tincidunt condimentum. Nisi ultrices eu venenatis
                diam.
              </p>
              <p>
                Illum quaerat ab inventore, eveniet repudiandae saepe, iste sed molestias laborum
