...
const Footer = () => {
    return (
        <footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-300 bg-gray-100">
          <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div className="lg:w-1/3">
              ...
              >
                ...
                <span className="self-center text-3xl font-extrabold font-mono">Edu Flash</span>
              </Link>
            </div>
