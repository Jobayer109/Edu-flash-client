...
import { FaBackward, FaDollarSign, FaFilePdf, FaStar, FaThumbsUp } from "react-icons/fa";
    ...
    <div>
      <div className="max-w-sm w-full lg:max-w-[70%]  lg:mx-auto lg:flex border-1 shadow-lg rounded-lg p-8 mt-8 mb-24">
        <div className=" h-48 lg:h-60 lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden">
          <Link to="/courses">
            <FaBackward className="text-3xl ml-6 text-white text-center bg-black p-1 rounded-lg motion-safe:hover:scale-110" />
          </Link>
        ...
        <div className=" lg:border-gray-400 w-[80%] mx-auto rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal bg-gray-100 rounded-2xl">
          <div className="mb-8">
            <p className="text-sm text-gray-600 flex items-center justify-end">
              <FaFilePdf className="text-4xl text-red-600 motion-safe:hover:scale-110 shadow-xl"></FaFilePdf>
            </p>
            <div className="shadow-xl rounded-lg mb-3 p-1">
          ...
          <div className="mt-10">
            <h2 className="text-2xl font-mono font-extrabold">Features of this course:</h2>
            <div className="flex justify-between items-center">
              {lessons.map((lesson) => (
                <div className="border-2 bg-orange-900 text-white h-16 w-28 text-center p-2 px-3 font-semibold rounded-r-full rounded-lg mt-4 shadow-lg">
                  {" "}
                  {lesson}
                </div>
              ))}
          ...
          <div className="text-center mt-10">
            <p className="text-sm font-mono">
              To get the best and high quality teaching from our platform, <br /> you may explore our
              premium courses.
            </p>
            <Link to="/premium">
              <button className="btn btn-primary mt-3 w-96 shadow-lg">Premium Course</button>
            </Link>
          </div>
        </div>
      </div>
